...
use icequeen\sm\ecc\Sm2Curve;

use Mdanter\Ecc\Crypto\Signature\Signer;
use icequeen\sm\ecc\Sm2Signer;
...
use icequeen\sm\smecc\SM2\Sm2WithSm3;
use icequeen\sm\smecc\SM2\Hex2ByteBuf;
...
class MySm2 {
    ...
    function __construct($formatSign='hex') {
        ...
        // $smc = new Sm2Curve($this->adapter);
        // $this->generator = $smc->generatorSm2();
